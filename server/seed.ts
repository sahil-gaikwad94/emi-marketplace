...
const products = [
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1592286927505-2fd0f3c06e4d?auto=format&fit=crop&w=1000&q=88",
    accentColor: "#f3a36e",
    rating: "4.8",
    reviewCount: 284,
    featured: true,
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?auto=format&fit=crop&w=1000&q=88",
    accentColor: "#b6c9e8",
    rating: "4.7",
    reviewCount: 197,
    featured: false,
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1556656793-08538906a9f8?auto=format&fit=crop&w=1000&q=88",
    accentColor: "#c7b7ff",
    rating: "4.6",
    reviewCount: 126,
    featured: false,
...
const variantSeed = [
  {
    ...
    variants: [
      { sku: "APL-IP17P-SLV-256", label: "Silver / 256 GB", colorName: "Silver", colorHex: "#d7d8d9", storage: "256 GB", mrpInPaise: 13400000, priceInPaise: 12740000, imageUrl: "https://images.unsplash.com/photo-1592286927505-2fd0f3c06e4d?auto=format&fit=crop&w=1000&q=88" },
      { sku: "APL-IP17P-ORG-512", label: "Desert Orange / 512 GB", colorName: "Desert Orange", colorHex: "#d87845", storage: "512 GB", mrpInPaise: 15400000, priceInPaise: 14650000, imageUrl: "https://images.unsplash.com/photo-1605236453806-6ff36851218e?auto=format&fit=crop&w=1000&q=88" },
      { sku: "APL-IP17P-NVY-1TB", label: "Deep Navy / 1 TB", colorName: "Deep Navy", colorHex: "#1e2f45", storage: "1 TB", mrpInPaise: 17400000, priceInPaise: 16580000, imageUrl: "https://images.unsplash.com/photo-1603921326210-6edd2d60ca68?auto=format&fit=crop&w=1000&q=88" },
    ],
  },
  {
    productSlug: "samsung-galaxy-s24-ultra",
    variants: [
      { sku: "SAM-S24U-BLK-256", label: "Titanium Black / 256 GB", colorName: "Titanium Black", colorHex: "#252525", storage: "256 GB", mrpInPaise: 13499900, priceInPaise: 9999000, imageUrl: "https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?auto=format&fit=crop&w=1000&q=88" },
      { sku: "SAM-S24U-VLT-512", label: "Titanium Violet / 512 GB", colorName: "Titanium Violet", colorHex: "#827391", storage: "512 GB", mrpInPaise: 14499900, priceInPaise: 11299000, imageUrl: "https://images.unsplash.com/photo-1625895197185-efcec01cffe0?auto=format&fit=crop&w=1000&q=88" },
    ],
  },
  {
    productSlug: "oneplus-13",
    variants: [
      { sku: "OP13-BLK-256", label: "Midnight Black / 256 GB", colorName: "Midnight Black", colorHex: "#212124", storage: "256 GB", mrpInPaise: 6999000, priceInPaise: 5999000, imageUrl: "https://images.unsplash.com/photo-1556656793-08538906a9f8?auto=format&fit=crop&w=1000&q=88" },
